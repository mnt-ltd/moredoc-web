        ...
        <div v-show="!user.id">
            <template v-if="existAccount">
                <el-tabs v-if="settings.system.enable_sms">
                    ...
                    <form-login :isOauthBind="true" @onSuccess="bind"></form-login>
                    </el-tab-pane>
                    <el-tab-pane label="短信登录并绑定">
                    <form-login-mobile  :isOauthBind="true" @onSuccess="bind"></form-login-mobile>
                    </el-tab-pane>
                </el-tabs>
                <form-login v-else  :isOauthBind="true" @onSuccess="bind"></form-login>
            </template>
            <template v-else>
                <el-tabs v-if="settings.system.enable_sms">
                <el-tab-pane label="邮箱注册并绑定">
                    <form-register  :isOauthBind="true" @onSuccess="bind"></form-register>
                </el-tab-pane>
                <el-tab-pane label="手机注册并绑定">
                    <form-register-mobile  :isOauthBind="true" @onSuccess="bind"></form-register-mobile>
                </el-tab-pane>
                </el-tabs>
                <form-register v-else  :isOauthBind="true" @onSuccess="bind"></form-register>
            </template>
